...
//These 4 followings are Beny5's information. So, when you are gonna use, revise them to yours.
...
void loop() {
  ...
  ThingSpeak.writeFields(myChannelNumber, myWriteAPIKey);  //Write fields to Thingspeak, comment this line out
    ...
    finished=millis();
    elapsed=finished-start1;//It makes thingspeak mark temperature 60 seconds without error.
  delay(60000-elapsed);
}
